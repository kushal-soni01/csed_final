...
export default function App() {
  ...
  const eventData = {
    ...
    description: 'Join us for an exciting series of workshops, keynote speeches, and networking events. Our annual tech summit is dedicated to fostering innovation, promoting creativity, and connecting the brightest minds in the industry. Explore cutting-edge technologies and gain insights from leading experts.',
    stats: [
  ...
  const completedEvents = [
    {
      ...
      summary: "A comprehensive technology conference featuring the latest innovations in AI, machine learning, and neural networks with industry leaders.",
      description: "The AI & Machine Learning Summit 2024 brought together industry leaders, researchers, and tech enthusiasts for a day of groundbreaking presentations and networking. Attendees explored cutting-edge AI technologies, learned from expert speakers, and connected with like-minded professionals in the rapidly evolving field of artificial intelligence.",
      perks: [
      ...
      sponsors: {
        platinum: [
          { name: "NVIDIA", logo: "https://via.placeholder.com/200x80/76B900/FFFFFF?text=NVIDIA" },
          { name: "Google AI", logo: "https://via.placeholder.com/200x80/4285F4/FFFFFF?text=Google+AI" }
        ],
        gold: [
          { name: "Microsoft", logo: "https://via.placeholder.com/150x60/00BCF2/FFFFFF?text=Microsoft" },
          { name: "OpenAI", logo: "https://via.placeholder.com/150x60/412991/FFFFFF?text=OpenAI" },
          { name: "Meta AI", logo: "https://via.placeholder.com/150x60/1877F2/FFFFFF?text=Meta+AI" }
        ],
        silver: [
          { name: "Hugging Face", logo: "https://via.placeholder.com/120x50/FFD21E/000000?text=🤗+HF" },
          { name: "Anthropic", logo: "https://via.placeholder.com/120x50/8B5CF6/FFFFFF?text=Anthropic" },
          { name: "Cohere", logo: "https://via.placeholder.com/120x50/39C5BB/FFFFFF?text=Cohere" }
        ]
      }
    },
    {
      ...
      summary: "Explore the future of digital marketing with AI-powered strategies, influencer marketing, and data-driven campaigns that convert.",
      description: "The Digital Marketing Revolution showcased the latest trends, tools, and techniques in digital marketing. From AI-powered social media strategies to advanced data analytics, attendees gained valuable insights to drive their marketing efforts forward in 2024 and beyond.",
      perks: [
      ...
      sponsors: {
        platinum: [
          { name: "HubSpot", logo: "https://via.placeholder.com/200x80/FF7A59/FFFFFF?text=HubSpot" },
          { name: "Salesforce", logo: "https://via.placeholder.com/200x80/00A1E0/FFFFFF?text=Salesforce" }
        ],
        gold: [
          { name: "Mailchimp", logo: "https://via.placeholder.com/150x60/FFE01B/000000?text=Mailchimp" },
          { name: "Shopify", logo: "https://via.placeholder.com/150x60/96BF47/FFFFFF?text=Shopify" }
        ],
        silver: [
          { name: "Buffer", logo: "https://via.placeholder.com/120x50/168EEA/FFFFFF?text=Buffer" },
          { name: "Canva", logo: "https://via.placeholder.com/120x50/00C4CC/FFFFFF?text=Canva" }
        ]
      }
    },
    {
      ...
      sponsors: {
        platinum: [
          { name: "Coinbase", logo: "https://via.placeholder.com/200x80/0052FF/FFFFFF?text=Coinbase" },
          { name: "Binance", logo: "https://via.placeholder.com/200x80/F3BA2F/000000?text=Binance" }
        ],
        gold: [
          { name: "Polygon", logo: "https://via.placeholder.com/150x60/8247E5/FFFFFF?text=Polygon" },
          { name: "Chainlink", logo: "https://via.placeholder.com/150x60/375BD2/FFFFFF?text=Chainlink" },
          { name: "Solana", logo: "https://via.placeholder.com/150x60/14F195/000000?text=Solana" }
        ],
        silver: [
          { name: "MetaMask", logo: "https://via.placeholder.com/120x50/F6851B/FFFFFF?text=MetaMask" },
          { name: "Uniswap", logo: "https://via.placeholder.com/120x50/FF007A/FFFFFF?text=Uniswap" },
          { name: "OpenSea", logo: "https://via.placeholder.com/120x50/2081E2/FFFFFF?text=OpenSea" }
        ]
      }
    },
    {
  ...
  const horizontalEventData = [
    {
      ...
      time: '10:00-3:00',
      title: 'Workshop 1',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla quam veritatis, consectetur adipiscing elit.'
    },
    {
      id: 2,
      date: '8 Aug',
  ...
  return (
    <div className="App" style={{ background: 'var(--primary-bg)' }}>
      <div className="hero-background-shapes"></div> {/* Single, full-page background animation */}
      ...
      <main className="content-wrapper">
       ...
       <div style={{ marginTop: '6rem' }}> {/* New wrapper div for spacing */}
        ...
        <ScrollRevealText>
          ...
          <p>
            Stay updated with our event calendar for the month of August 2025
          </p>
        </ScrollRevealText>
        </main>

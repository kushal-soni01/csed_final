...
export default function EventsHero() {
	...
	useEffect(() => {
		...
		const timer = setTimeout(() => {
			const eventsWordsElements =
				document.querySelectorAll(".events_words");
			...
			if (eventsWordsElements.length > 0) {
				...
				for (let i = 0; i < eventsWordsElements.length; i++) {
					...
					// Hide current word
					newtl.to(
						eventsWordsElements[currentIndex],
						{
							y: "-100%",
							opacity: 0,
							duration: 0.6,
		...
		<>
			...
			<div className="events-hero-container" ref={eventsScrollRef}>
				...
				<div className="hero-background-shapes">
					...
					{/* Tech symbols */}
					<div className="hero-tech-symbol hero-symbol-1">
						&lt;/&gt;
					</div>
					<div className="hero-tech-symbol hero-symbol-2">{}</div>
					<div className="hero-tech-symbol hero-symbol-3">
						&lt;&gt;
					</div>
					<div className="hero-tech-symbol hero-symbol-4">
						console.log
					</div>
					<div className="hero-tech-symbol hero-symbol-5">
						function()
					</div>
